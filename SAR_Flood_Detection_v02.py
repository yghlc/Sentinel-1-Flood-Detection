...
#        if "Sigma0_VV" in granule:
#            tiff_outname = os.path.join(out_dir,granule.replace('_Sigma0_VV.tif','_FD_Results_LM.tif'))  
#        else:
#            tiff_outname = os.path.join(out_dir,granule.replace('_Sigma0_VH.tif','_FD_Results_LM.tif'))         
