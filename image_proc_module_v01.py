...
#            self.band[self.band == 0] = np.nan  # RKC mod 10/17/2022  - convert Sigma0 nodata values (i.e. =0) to NaNs
...
#        layer = kml.newgroundoverlay(name=name)
        layer = kml.newgroundoverlay(name='GroundOverlay') # RKC mod
